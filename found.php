    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Lost &amp; Found Property</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Found Property</h1>
                <p class="lead">We list any property we have found or had handed in here</p>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="col-xs-12">
        	<hr>
        	<p>
        		<a onCLick="window.location.reload()" class="btn btn-primary"><span class="fa fa-refresh"></span> Refresh</a> 
        		<a href="mailto:lostproperty@chesterlestreetasc.co.uk" class="btn btn-success"><i class="fa fa-envelope"></i> Claim Lost Property</a>
        	</p>
        </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                */
                    ...
                    function importGSS(json) {
                        ...
                        console.dir(json);
                         ...
                         for (var i = 0; i < json.feed.entry.length; i++) {
                            ...
                            var line = '<td>' + clothing_item + '</td>' + '<td>' + brand + '</td>' + '<td>' + description + '</td>' + '<td>' + ititials + '</td>';
                            document.write(line);
                            }
                ...
                <script src="https://spreadsheets.google.com/feeds/list/1vNzmyrntHVyU0-Vs95he2eXcP6DgG01-7F47d_tfwdY/od6/public/values?alt=json-in-script&callback=importGSS"></script>
